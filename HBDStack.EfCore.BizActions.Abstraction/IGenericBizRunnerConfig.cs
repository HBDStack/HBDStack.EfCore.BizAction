...
public interface IGenericBizRunnerConfig
{
    ...
    ///     Alternatively you can add the IDoNotValidateSaveChanges interface to individual business logic interface
    ///     definitions
    /// </summary>
    ...
    /// <summary>
    ///     If the business logic writes to the database and does not set a success message then this default message will be
    ...
    /// </summary>
    Func<Exception, IStatusGeneric> SaveChangesExceptionHandler { get; }

    /// <summary>
    ///     This will be called just before SaveChanges/SaveChangesAsync is called.
    ///     I allows you to do things like your own validation, logging, etc. without needing to put code inside your
