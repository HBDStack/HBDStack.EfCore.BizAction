...
namespace HBDStack.EfCore.BizAction.Internal;

/// <summary>
///     This class generates the correct version of the ActionService.
///     I do this to make the service class signiture managable while still being able to call actions directly, i.e. no
///     reflection.
...
internal class BizDecoder
{
        ...
        ServiceBuilderLookup serviceBaseInfo)
    {
        ...
        throw new InvalidOperationException(
            string.Format(
                "Your call of {0} needed '{1}' but the Business class had a different setup of '{2}'",
                iBizType.Name, requestedInOut, serviceBaseInfo.TypeOfService));
    }
}