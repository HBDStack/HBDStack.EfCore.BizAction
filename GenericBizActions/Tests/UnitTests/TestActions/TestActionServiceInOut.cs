...
public class TestActionServiceInOut
{
    ...
    public void TestCallHasNoInputBad()
    {
        ...
        ex.Message.ShouldEqual(
            "Your call of IBizActionValueInOut needed 'Out' but the Business class had a different setup of 'InOut'");
    }
    ...
    public void TestCallHasNoOutputBad()
    {
        ...
        //VERIFY
        ex.Message.ShouldEqual(
            "Your call of IBizActionValueInOut needed 'In' but the Business class had a different setup of 'InOut'");
    }
    ...
    public void TestInputIsBad()
    {
        ...
        //ATTEMPT
        var ex = Assert.Throws<RuntimeBinderException>(() => runner.RunBizAction<string>(input));
