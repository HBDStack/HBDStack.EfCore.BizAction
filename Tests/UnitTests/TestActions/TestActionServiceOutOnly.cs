...
public class TestActionServiceOutOnly
{
    ...
    public void TestActionServiceOutOnlyDirectOk()
    {
        ...
        var runner = new ActionServiceAsync<IBizActionOutOnlyAsync>(_emptyDbContext, bizInstance, _wrappedConfig);
    ...
    public void TestCallHasNoOutputBad()
    {
        ...
        ex.Message.ShouldEqual(
            "Your call of IBizActionOutOnly needed 'In' but the Business class had a different setup of 'Out'");
    }
    ...
    public void TestInputIsBad()
    {
        ...
        //VERIFY
        ex.Message.ShouldEqual(
            "Your call of IBizActionOutOnly needed 'InOut' but the Business class had a different setup of 'Out'");
    }
    ...
    //    //ATTEMPT
    //    var ex = Assert.Throws<InvalidOperationException>(() => runner.RunBizAction<BizDataOut>());
