...
public class TestActionServiceInOnly
{
    ...
    public void TestActionServiceInOutDirectOk(int num, bool hasErrors)
    {
        ...
        bizInstance.Message.ShouldEqual(hasErrors ? "Failed with 1 error" : "All Ok");
    }
    ...
    public void TestCallHasOutputBad()
    {
        ...
        ex.Message.ShouldEqual(
            "Your call of IBizActionInOnly needed 'InOut' but the Business class had a different setup of 'In'");
    }
    ...
    public void TestInputIsBad()
    {
        ...
        //ATTEMPT
        var ex = Assert.Throws<RuntimeBinderException>(() => runner.RunBizAction(input));
