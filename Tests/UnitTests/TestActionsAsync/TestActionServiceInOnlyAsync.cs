...
public class TestActionServiceInOnlyAsync
{
    ...
    public async Task TestActionServiceDtosDatabaseOk(int num, bool hasErrors)
    {
        ...
        //ATTEMPT
        await runner.RunBizActionAsync(input).ConfigureAwait(false);
    ...
    public async Task TestCallHasOutputBad()
    {
        ...
        ex.Message.ShouldEqual(
            "Your call of IBizActionInOnlyAsync needed 'InOut, Async' but the Business class had a different setup of 'In, Async'");
    }
    ...
    public async Task TestInputIsBad()
    {
        ...
        //ATTEMPT
        var ex = await Assert.ThrowsAsync<RuntimeBinderException>(async () =>
